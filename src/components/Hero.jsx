  ...
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`} style={{ fontSize: '3.5rem' }}>
            Hi, I'm <span className='text-[#915EFF]'>Bhupendra</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`} style={{ fontSize: '1.5rem' }}>
      ...
      {/* <div className='absolute xs:bottom-[-80px] w-full flex justify-center items-center'>
        <a href='#about'>
